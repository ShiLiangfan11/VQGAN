...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained-model-path', type=str, default=None, help='Path to pre-trained model')

    args = parser.parse_args()
    args.dataset_path = r"/home/dongnan/SLF/data/pic_coms/train"
